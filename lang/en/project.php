...
$string['address'] = 'Add a ressource';
...
$string['introproject'] = 'Description';
...
$string['project'] = 'project';
$string['project:addinstance'] = 'Add a project';
$string['project:beassignedtasks'] = 'Be assigned tasks';
$string['project:canattachfiles'] = 'Can attach files';
$string['project:canbeevaluated'] = 'Be evaluated';
$string['project:changedelivs'] = 'Edit deliverables';
$string['project:changemiles'] = 'Define milestones';
$string['project:changenotownedtasks'] = 'Change not owned tasks (within group)';
$string['project:changerequs'] = 'Edit specifications';
$string['project:changespecs'] = 'Edit project requirements';
$string['project:changetasks'] = 'Edit and change tasks';
$string['project:gradeproject'] = 'Define assessment and evaluate the project';
$string['project:manage'] = 'Manage the project environment';
$string['project:configure'] = 'Configure the project environment';
$string['project:managecriteria'] = 'Manage evaluation criteria';
$string['project:manageremoterepository'] = 'Manage remote repository (CVS)';
$string['project:managevalidations'] = 'Manage validation sessions';
$string['project:posttodelivs'] = 'Post to deliverables';
$string['project:validate'] = 'Validate';
$string['project:viewpreproductionentities'] = 'View preproduction entities';
$string['project:viewprojectcontrols'] = 'View project control screens';
$string['project_help'] = 'project';
...
$string['CREATYPEPROJET'] = 'Type of project';
$string['CREAPROJET'] = 'Project';
$string['choixprojet'] = 'Genre';
$string['notype'] = 'No project type defined';
...
$string['notifymilestonchangeaskvalid'] = 'Demande de validation pour une étape';
$string['notifymilestonchangeaskrevalid'] = 'Demander de révision pour une étape';
$string['notifymilestonchangevalid'] = 'Une étape a été validée';
$string['messages'] = 'Messages';
$string['adddiscu'] = 'Ajouter une discussion';
$string['addmessage'] = 'Ajouter un message';
$string['errormessage'] = 'Error in messages';
...
';
$string['modulename_help']=  ' Aide du module project
';
$string['typeelm_help']=  ' 
...
$string['worktype_help'] = '
<p>This qualifier tells what kind of work is to be done. Knowing what skills are usefull for a particular task may be of great help
...
<p>If this option is enabled, assigned entities can be deleted without explicitely being previously unassigned. Relevant
...
<p>When enabled, participants are notified by mail when data that are relevant for them is changed.</p>
';

$string['autogradingenabled_help'] = '
<p>This option activates an internal automated grading calculation based on the compilation of entered information units. This grade
...
<p>The autograde will be mixed with the other grades using this weight factor. You may enter non integer numeric values here.</p>
';

$string['costelapsed_help'] = '
<p>This qualifier will allow calculating the quality of the project estimation. By indicating AFTER WORK IS DONE the real time cost of
...
<p>This qualifier allows giving a foreseeing estimation of time cost of the current task. This cost should be entered in current
...
<p>A <b>criterion</b> is a keyword for identifying the grading element. It should be entered as a single textual token, without
any spaces.</p>
';

$string['deliv_status_help'] = '
<p>This qualifier determines the status of a deliverable object. Here are default values for a standard software package typical deliverable:</p>
...
<p>When enabled, the project module will calculate a single grade per user for the user\'s notebook in Moodle. The grade is calculated
...
<p>When this option is enabled, guests can browse within the project workspaces. Guests are allowed to see the "default
...
"help.php?module=project&amp;file=guestscanuse.html&amp;forcelang=fr_utf8"> </a>).</li>
...
<p>You can let a guest edit some data on the default workspace (out of group). This is reserved for demos and needs groups to be
...
<p>This criteria set applies to individual assessable elements (i.e. one grade per assessable element). All assessable elements
...
<p>This feature will allow importing a complete entity tree from a CSV file.</p>
...
$string['leaves_help'] = '
<p>"Effective" entities are those that are not splitted into subbentites (leaves). They are "terminal" elements of the project,
...
<p>This qualifier allows setting a priority for a specification. Priority will have influence on the tasks items that have been
...
<p>This qualifier qualifies severity of a specification, i.e., the importance it will have in the final delivery.</p>
...
$string['strength_help'] = '
<p>Strength is the measurement of the importance of the requirement for the customer.</p>
';

$string['spec_to_req_help'] = '
<p>This selector maps current specification to relevant requirements, according to the following semantic.</p>
...
$string['status_help'] = '
<p>This qualifier tells in which state the task is. Task life cicle will occur changing from state to state. In step 1, task status
changing is free.</p>
...
$string['strengh_help'] = '
<p>This qualifier allows defining some "strength" of a requirement, i.e., some measurement of the importance the customer attached to
this requirement.</p>
...
<p>A deadline can be set for a task. This deadline MUST be consistant with task start date against task estimated duration
:</p>
...
$string['task_to_deliv_help'] = '
<p>Tasks are performed in order to produce some concrete parts of the project\'s goal. These identified products are so called
"deliverables".</p>
...
$string['task_to_miles_help'] = '
<p>A task can be assigned a milestone. When mapped to a milestone, some constraints on deadlines are added. The task is known as
...
$string['task_to_spec_help'] = '
<p>Task can be designated as realizing some subset of specifications. A single task may realize multiple specifications,
